...
public class CHighlighter extends SyntaxHighlighterBase {
    ...
    public final static TokenSet allKeywords = TokenSet.create(K_WHILE, K_FOR, K_IF, K_ELSE, K_ENUM, K_SWITCH, K_CASE,
            K_CLASS, K_DO, K_VOID, K_CONST, K_INLINE, K_STATIC, K_VIRTUAL, K_RETURN, K_AUTOWAIT, K_AUTOCALL,
            K_WAITEVENT, K_EVENT, K_NAME, K_THUMBNAIL, K_FEATURES, K_USES, K_EXPORT, K_TEXTURE, K_SOUND, K_MODEL,
